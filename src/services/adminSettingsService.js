...
export const SETTING_DEFINITIONS = [
  ...
  { key: 'limits.per_user_requests', label: 'Per-user request rate limit', type: 'json', defaultValue: { window_seconds: 60, max_requests: 600 }, description: 'Per-user API request rate limit.' },
  { key: 'limits.per_endpoint_requests', label: 'Per-endpoint request rate limit', type: 'json', defaultValue: { window_seconds: 60, max_requests: 300 }, description: 'Per-endpoint API request rate limit.' },
  { key: 'limits.failed_auth_attempts', label: 'Failed API auth throttle', type: 'json', defaultValue: { window_seconds: 300, max_requests: 20 }, description: 'Throttle repeated missing or invalid API keys.' },
  { key: 'limits.login_attempts', label: 'Login throttle', type: 'json', defaultValue: { window_seconds: 300, max_requests: 10 }, description: 'Throttle repeated login attempts by IP and email.' },
  { key: 'limits.signup_attempts', label: 'Signup throttle', type: 'json', defaultValue: { window_seconds: 3600, max_requests: 5 }, description: 'Throttle signup attempts by IP.' },
  { key: 'security.ip_access_lists_enabled', label: 'IP allow/block lists enabled', type: 'boolean', defaultValue: false, description: 'Enforce optional API IP allowlist and blocklist rules.' },
